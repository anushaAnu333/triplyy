...
// Bank account number: digits with optional spaces/dashes (typical 5–34 chars)
const accountNumberRegex = /^[\d\s-]{5,34}$/;
...
export const businessInfoSchema = z.object({
  ...
  accountNumber: z
    ...
    .regex(accountNumberRegex, 'Enter a valid account number (5–34 digits, spaces or dashes allowed)'),
